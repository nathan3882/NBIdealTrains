...
public class IdealTrains {
    ...
    public static final String AUTHENTICATION_TOKEN = "your token here";
    ...
    public static void main(String args[]) throws SOAPException, IOException, DatatypeConfigurationException, JAXBException, Exception {
        ...
        String action = "GetDepartureBoardByCRS";
        ...
        String soapEndpointUrl = "https://lite.realtime.nationalrail.co.uk/OpenLDBSVWS/ldbsv12.asmx";
        
        SOAPMessage response = getSoapResponse(soapMessage, soapEndpointUrl);
    }
    ...
    private static SOAPMessage getSoapResponse(SOAPMessage soapRequest, String soapEndpointUrl) {
        try {
